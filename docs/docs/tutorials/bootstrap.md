...
!!! note "Note"
    ...
    Addresses in `peers.txt` need samples number for every peer at end of the line.
    When adding peer manually, it is recommended to use the samples range from 20 to 24.
